...
def create_and_upload_gbq_table(csv_file, table_name): 
...
if __name__ == "__main__":
    ...
    sdlc_parser.add_argument("--csvFile", "-csv", help="Specify CSV file to convert and upload to Google BigQuery")  
    ...
    create_and_upload_gbq_table(args.csvFile, args.tableName)
